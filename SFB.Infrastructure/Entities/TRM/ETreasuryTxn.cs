...
namespace SFB.Infrastructure.Entities.TRM
{
    ...
    public class ETreasuryTxn : Auditable
    {
        [Key, Required]
        ...
        public virtual ECashBox? CashBoxOrigin { get; set; }

        // Caja destino (puede ser null según tu regla)
        public int? CashBoxDestId { get; set; }
        [ForeignKey(nameof(CashBoxDestId))]
        public virtual ECashBox? CashBoxDest { get; set; }
        ...
        public virtual ICollection<ETreasuryDetail> Details { get; set; } = new List<ETreasuryDetail>();
    }
}
