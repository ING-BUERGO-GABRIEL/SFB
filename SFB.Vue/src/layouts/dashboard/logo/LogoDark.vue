    ...
    <RouterLink to="/dashboard" aria-label="logo">
      <svg width="150" height="35" viewBox="0 0 150 35" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          :fill="darkprimary"></path>
        <path
          d="M7.35025 17.5L9.1228 15.7275L9.5697 15.2805L7.83937 13.5496H6.95039L6.94798 13.552L4.63564 15.8644L6.85510 18.073L7.35025 17.5Z"
          :fill="darkprimary"></path>
        <path
          ...
          :fill="darkprimary"></path>
        <path d="M6.94549 13.5496L6.94790 13.552L9.12272 15.7275L17.4999 24.1041L28.0544 13.5496H6.94549Z"
          :fill="primary"></path>
        <text x="42" y="24" font-family="'Public Sans', sans-serif" font-size="15" font-weight="700" fill="#000">
          Easy Hardware
        </text>
        <defs>
