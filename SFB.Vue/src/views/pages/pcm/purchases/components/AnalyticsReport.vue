...
const reports = shallowRef([
  { name: 'Órdenes activas', percent: '+8.4%' },
  { name: 'Ticket promedio', percent: '310 BOB' },
  { name: 'Pendientes', percent: '2 en revisión' }
])
</script>

<template>
  <UiTitleCard title="Analytics" class-name="px-0 rounded-md overflow-hidden">
