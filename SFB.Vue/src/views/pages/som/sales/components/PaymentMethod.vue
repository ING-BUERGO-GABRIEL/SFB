<template>
  <card-dialog v-model="showModal" title="Métodos de pago" height="540" @accept="onAccept" @cancel="onCancel">
      ...
      <v-col cols="12" v-for="(detail, idx) in details" :key="idx" class="pb-0">
        <v-card variant="outlined" class="pa-3">
          <v-row dense align="center">
            <v-col cols="12" sm="4">
              <v-select v-model="detail.PaymentMethodCode" :items="paymentMethods" item-title="Name" item-value="Code"
                label="Método" density="compact" variant="outlined" hide-details />
            </v-col>
            <v-col cols="12" sm="4">
